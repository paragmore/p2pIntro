...
class Hypernews {
  ...
  info() {
    ...
    console.log(
      "Autobase setup. Use this to run an additional instance with the current one as an input:"
    );
    console.log();
    console.log(
      "hrepl hypernews.js " +
        ...
        this.autobase.inputs
          ...
          .join(" ") +
        " " +
        this.autobase.outputs
          .map((o) => "-o " + o.key.toString("hex"))
          .join(" ") +
        " --storage ./instanceN"
    );
    console.log();
    ...
    console.log();
    console.log(
      "Note: for the first instance to accept updates of the second instance, it needs to have the second instance as an input."
    );
    console.log(
      "This can be achieved by starting it with the -i " +
        localInputHex +
        " option"
    );
    console.log(
      "or at runtime with: hypernews.autobase.addInput(hypernews.store.get(Buffer.from('" +
        localInputHex +
        "', 'hex')))"
    );
    console.log();
